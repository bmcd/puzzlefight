...
var resetDim = function(windowWidth) {
	...
	$('#background').height(windowWidth * 0.65);
	...
	$('#playerA').width(normWidth);
	$('#playerA').height(normHeight);
	$('#playerA').css('top', topGap);
	$('#playerA').css('left', leftGap);
	$('#playerB').width(normWidth);
	$('#playerB').height(normHeight);
	$('#playerB').css('top', topGap);
	$('#playerB').css('left', playerACanvas.width * 2 + leftGap);
	$('#playerABoat').width(normWidth);
	$('#playerABoat').height(normHeight);
	$('#playerABoat').css('top', topGap);
	$('#playerABoat').css('left', leftGap);
	$('#playerBBoat').width(normWidth);
	$('#playerBBoat').height(normHeight);
	$('#playerBBoat').css('top', topGap);
	$('#playerBBoat').css('left', playerACanvas.width * 2 + leftGap);
	$('#playerAWaiting').width(normWidth / 2.0);
	$('#playerAWaiting').height(normHeight);
	$('#playerAwaiting').css('top', topGap);
	$('#playerAWaiting').css('left', playerACanvas.width + leftGap);
	$('#playerBWaiting').width(normWidth / 2.0);
	$('#playerBWaiting').height(normHeight);
	$('#playerBwaiting').css('top', topGap);
	$('#playerBWaiting').css('left', playerACanvas.width + leftGap + playerAWaitingCanvas.width);
	$('#roundCanvas').width(normWidth);
	$('#roundCanvas').height(normHeight);
	$('#roundCanvas').css('top', topGap);
	$('#roundCanvas').css('left', playerACanvas.width + leftGap);
